<template>
  <div class="container">
    ...
    <footer class="footer">
      <span class="copyright">&copy; {{ new Date().getFullYear() }} TaskAgile.com</span>
      <ul class="footer-links list-inline float-right">
        <li class="list-inline-item"><a href="#">About</a></li>
        <li class="list-inline-item"><a href="#">Terms of Service</a></li>
        <li class="list-inline-item"><a href="#">Privacy Policy</a></li>
        <li class="list-inline-item"><a href="https://github.com/edkinsgael9/TaskAgile" target="_blank">GitHub</a></li>
      </ul>
    </footer>
  </div>
</template>
